...
//forward to stop animation to run once, repeat reverse to repeating
  ...
  @override
  Widget build(BuildContext context) {
    return AnimateElements(controller: _controller, left: 158, top: 323, width: 75, height: 75,
...
class AnimateElements extends StatelessWidget {
  const AnimateElements({
    Key? key,
    required AnimationController controller, required this.left, required this.top, required this.width, required this.height, required this.left2, required this.top2, required this.width2, required this.height2, required this.container,
